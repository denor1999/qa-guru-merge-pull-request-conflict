...
public class LoginTests extends TestBase{
    ...
    //Don't use in Login form tests. Create new class
    @Test
    void headerClickButtonsTest(){
        open("/login.html");
        $("[data-testid=forms-link]").click();
        $("[class=demo-section-title]").shouldHave(text("Demo pages"));
    }

    @Test
    void footerIsVisibleOnTextBoxFormTest(){
        open("/login.html");
        $("[data-testid=clubs-link]").click();
        $("[class=site-footer").shouldBe(visible);
    }
}
